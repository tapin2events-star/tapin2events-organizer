...
export interface TapEvent {
  ...
  seating_sections: { name: string; price: number; num_tables: number; seats_per_table: number; total_seats: number; color: string; bundle_enabled?: boolean; bundle_price?: number; bundle_description?: string; bundle_product_id?: string | null }[] | null;
